  ...
  return (
    <aside>
      ...
      <nav aria-label="Books">
        <a aria-label="US Books" title="US Books" className={!india && !gr ? "on" : ""} href="/ledger">
          <span className="nav-full">US Books</span>
          <span className="nav-short">US</span>
        </a>
        <a aria-label="India Books" title="India Books" className={india ? "on" : ""} href="/india">
          <span className="nav-full">India Books</span>
          <span className="nav-short">IN</span>
        </a>
        <a aria-label="GR Consolidated" title="GR Consolidated" className={gr ? "on" : ""} href="/gr">
